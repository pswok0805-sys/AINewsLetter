...
한국어로만 작성하세요. 한자(중국어/일본어 문자)는 단 한 글자도 사용하지 마세요.
한자가 포함되면 실패한 응답입니다. 오직 한글, 영문, 숫자, 특수문자만 사용하세요.
아래 형식으로 작성해주세요:
...
1. [뉴스 제목]
   📝 요약 및 해석: 핵심 내용 요약과 AI나 기술을 모르는 초보자도 이해할 수 있도록 쉬운 말로 3~4줄 설명. 이 뉴스가 왜 중요한지, 앞으로 어떤 영향을 미칠지도 포함해주세요.
   🔗 링크: [URL]
[빈 줄]
2. [뉴스 제목]
...

뉴스와 뉴스 사이에는 반드시 빈 줄 하나를 넣어주세요.
